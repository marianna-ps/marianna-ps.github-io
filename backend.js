...
function original_list() {
    ...
    c_list.push(['For every toy brought into the truck, you can bring one piece of equipment in the house', '0'])
    c_list.push(['There can be only 3 pieces of equipment in the house simultaneously (excluding flashlights)', '1']) 
    c_list.push(['You can only use glow-sticks for fingerprints', '0'])
